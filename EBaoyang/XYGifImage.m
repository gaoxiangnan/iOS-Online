...
+ (UIImage *)imageNamed:(NSString *)name
{
    ...
    return ([[NSFileManager defaultManager] fileExistsAtPath:path]) ? [XYGifImage imageWithContentsOfFile:path] : nil;
}

+ (UIImage *)imageWithContentsOfFile:(NSString *)path
{
    return [XYGifImage imageWithData:[NSData dataWithContentsOfFile:path]];
}
